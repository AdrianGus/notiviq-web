...
export function ConfirmDialog({ open, title, description, onConfirm, onCancel }: { open: boolean; title: string; description?: string; onConfirm: () => void; onCancel: () => void }) {
  if (!open) return null
  return (
    <div className="fixed inset-0 z-50 grid place-items-center justify-start">
      ...
      <div className="relative z-10 w-full max-w-sm rounded-xl bg-white p-6 shadow-lg">
        ...
        <div className="flex justify-start gap-2">
          <Button onClick={onCancel} className="bg-neutral-200 text-black hover:bg-neutral-300">Cancelar</Button>
